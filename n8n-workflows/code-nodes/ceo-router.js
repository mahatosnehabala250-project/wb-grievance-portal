...
const KEYWORDS = {
  blood: [
    ...
    /\b(khoon|khun|raqt|rakt|raktt|rakto|rakta|raktdaata|raktdata)\b/i,
    /\b(khoon|raqt|rakt)\s+(chahiye|chaahiye|ki\s+zaroorat|ki\s+jaroorat)\b/i,
    /\b(rokto|rokta|rakto|rakta)\s+(lagbe|chai|chahiye|proyojon|dorkar|chai)\b/i,
    /\bblood\s+lagbe\b/i,
    /\b(a|b|ab|o)\s*[+\-](?=\s|$|[^\w+\-])/i,
  ...
  donor: [
    ...
    /\b(rokto|rokta|rakto|rakta)\s+(dite|daan|donate)\b/i,
