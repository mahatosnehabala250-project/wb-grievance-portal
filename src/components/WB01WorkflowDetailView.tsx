            ...
            <Card className="p-4">
              <div className="space-y-3">
                ...
                {[
                  ...
                  { step: 9, title: 'Send Confirmation (WhatsApp)', detail: 'Rich bilingual message: ticket number, issue, category, location, urgency, department. Instructions for status check and rating. Portal branding footer.', icon: Send, color: 'bg-green-500' },
