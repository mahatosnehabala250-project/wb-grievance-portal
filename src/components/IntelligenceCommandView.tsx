        ...
        <div className="p-4 space-y-4">
            ...
            <CardHeader className="pb-1 pt-3 px-4">
              <CardTitle className="text-xs font-semibold flex items-center justify-between text-foreground tracking-tight">
                <span className="flex flex-col gap-0.5">
                  <span className="flex items-center gap-1.5 text-[13px] font-bold"><Target className="w-4 h-4 text-indigo-500" /> Priority Areas</span>
                  <span className="text-[10px] font-normal text-muted-foreground">One fused score per area — where to focus today, and why</span>
                </span>
                {!fusion && (
          ...
          <Card className={`border shadow-sm border-fuchsia-500/20 ${show('brain') ? '' : 'hidden'}`}>
            <CardHeader className="pb-1 pt-3 px-4">
              <CardTitle className="text-xs font-semibold flex items-center justify-between text-foreground tracking-tight">
                <span className="flex flex-col gap-0.5">
                  <span className="flex items-center gap-1.5 text-[13px] font-bold"><Sparkles className="w-4 h-4 text-fuchsia-500" /> Citizen Voice</span>
                  <span className="text-[10px] font-normal text-muted-foreground">AI read every complaint — the one issue people are most angry about</span>
                </span>
                {!nlp ? (
