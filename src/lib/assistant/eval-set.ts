...
export const EVAL_SET: EvalItem[] = [
  ...
  { id: 'anger', q: 'Sabse zyada gussa kis area mein hai?', expectTool: ['get_nlp_insights'] },
  { id: 'priority', q: 'Mujhe kaun se area pe sabse pehle dhyan dena chahiye?', expectTool: ['get_priority_areas', 'top_hotspots', 'get_overview'] },
